            ...
            <div class="col-lg-6">
              ...
              <div class="col-lg-6">
                <div class="portfolio-info">
                  <h3>Detail Profile Desa</h3>
                  <ul>
                    <li><strong>Nama</strong>: {{ $data->desa_nama }}</li>
                    <li><strong>Alamat</strong>: {{ $data->desa_alamat }}</li>
                    <li><strong>Telepon</strong>: {{ $data->desa_telp }}</li>
