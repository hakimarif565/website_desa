                    ...
                    <div class="col-md-4">
                        <figure class="card card-product">
                            ...
                            <figcaption class="d-flex info-wrap">
                                <h4 class="title"><a href='/umkm/{{ $data->item_id }}'>{{ $data->item_name }}</a></h4>
                            </figcaption>
                            <div class="d-flex bottom-wrap">
                                <a href="/umkm/{{ $data->item_id }}" class="btn btn-sm btn-success float-right"><i class="fa fa-cart-arrow-down"></i>{{ Str::title($data->usaha_nama) }}</a>
                            </div>
                        </figure>
                    </div>
                    @empty
